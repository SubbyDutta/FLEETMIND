...
def add_AgentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Analytics': grpc.unary_stream_rpc_method_handler(
                    servicer.Analytics,
                    request_deserializer=agent__pb2.ChatRequest.FromString,
                    response_serializer=agent__pb2.ChatEvent.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'fleetmind.agent.AgentService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('fleetmind.agent.AgentService', rpc_method_handlers)
